...
CGFLAGS=-g
SRC=./src
TARGET_ENCODER=$(SRC)/encoder.c $(SRC)/heap.c $(SRC)/tree.c $(SRC)/arraybyte.c $(SRC)/bitreader.c
TARGET_DECODER=$(SRC)/decoder.c $(SRC)/tree.c $(SRC)/arraybyte.c $(SRC)/bitreader.c
